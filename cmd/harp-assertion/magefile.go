...
func Test() {
	...
	mg.SerialDeps(
		func() error {
			return golang.UnitTest("github.com/elastic/harp-plugins/cmd/harp-assertion/pkg/...")()
		},
		func() error {
			return golang.UnitTest("github.com/elastic/harp-plugins/cmd/harp-assertion/internal/...")()
		},
	)
}
...
func Compile() error {
	// Extract
	version, err := git.TagMatch("cmd/harp-assertion/v*")
	if err != nil {
		return err
	}

	// Build artifact
	return golang.Build("harp-assertion", "github.com/elastic/harp-plugins/cmd/harp-assertion", version)()
}
	...
	mg.CtxDeps(ctx,
		func() error {
			return golang.Release(
				"harp-assertion",
				"github.com/elastic/harp-plugins/cmd/harp-assertion",
				version,
