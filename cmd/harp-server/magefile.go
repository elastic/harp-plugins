...
func Generate() {
	...
	golang.Generate("HTTP", "github.com/elastic/harp-plugins/cmd/harp-server/internal/dispatchers/http")()
	golang.Generate("Vault", "github.com/elastic/harp-plugins/cmd/harp-server/internal/dispatchers/vault")()
	golang.Generate("gRPC", "github.com/elastic/harp-plugins/cmd/harp-server/internal/dispatchers/grpc")()
}
...
func Test() {
	...
	mg.SerialDeps(
		func() error {
			return golang.UnitTest("github.com/elastic/harp-plugins/cmd/harp-server/internal/...")()
		},
	)
}
...
func Compile() error {
	// Extract git version
	version, err := git.TagMatch("cmd/harp-plugins/v*")
	if err != nil {
		return err
	}

	return golang.Build("harp-server", "github.com/elastic/harp-plugins/cmd/harp-server", version)()
}
