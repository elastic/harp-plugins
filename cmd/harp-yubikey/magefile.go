...
func Test() {
	...
	mg.SerialDeps(
		func() error {
			return golang.UnitTest("github.com/elastic/harp-plugins/cmd/harp-yubikey/pkg/...")()
		},
		func() error {
			return golang.UnitTest("github.com/elastic/harp-plugins/cmd/harp-yubikey/internal/...")()
		},
	)
}
...
func Compile() error {
	// Extract
	version, err := git.TagMatch("cmd/harp-yubikey/v*")
	if err != nil {
		return err
	}
	...
	mg.CtxDeps(ctx,
		func() error {
			return golang.Release(
				"harp-yubikey",
				"github.com/elastic/harp-plugins/cmd/harp-yubikey",
				version,
