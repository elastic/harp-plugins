...
func Test() {
	...
	mg.SerialDeps(
		func() error {
			return golang.UnitTest("github.com/elastic/harp-plugins/cmd/harp-aws/pkg/...")()
		},
		func() error {
			return golang.UnitTest("github.com/elastic/harp-plugins/cmd/harp-aws/internal/...")()
		},
	)
}
...
func Compile() error {
	// Extract
	version, err := git.TagMatch("cmd/harp-aws/v*")
	if err != nil {
		return err
	}

	// Build artifact
	return golang.Build("harp-aws", "github.com/elastic/harp-plugins/cmd/harp-aws", version)()
}
	...
	mg.CtxDeps(ctx,
		func() error {
			return golang.Release(
				"harp-aws",
				"github.com/elastic/harp-plugins/cmd/harp-aws",
				version,
