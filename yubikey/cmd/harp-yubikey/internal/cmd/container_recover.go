...
import (
	...
	"github.com/elastic/harp-plugins/yubikey/pkg/tasks/container"
...
var containerRecoveryCmd = func() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, _ []string) {
			...
			ctx, cancel := cmdutil.Context(cmd.Context(), "harp-yubikey-container-recover", conf.Debug.Enable, conf.Instrumentation.Logs.Level)
			defer cancel()
