...
import (
	...
	iconfig "github.com/elastic/harp-plugins/yubikey/cmd/harp-yubikey/internal/config"
)
...
var mainCmd = func() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "harp-yubikey",
		Short: "Harp Yubikey identity manager",
	}
	...
	cmd.AddCommand(configcmd.NewConfigCommand(conf, cmdPrefix))
