...
var descriptor = &artifact.Command{
	Package:     "github.com/elastic/harp-plugins/aws",
	Module:      "cmd/harp-aws",
	Name:        "Harp AWS",
	Description: "Harp AWS Operations",
}

// Build the artefact
func Build() {
	banner := figure.NewFigure("Harp AWS", "", true)
	banner.Print()
...
func Test() {
	...
	mg.SerialDeps(
		func() error {
			return golang.UnitTest("github.com/elastic/harp-plugins/aws/pkg/...")()
		},
		func() error {
			return golang.UnitTest("github.com/elastic/harp-plugins/aws/cmd/...")()
		},
	)
}
...
func Compile() error {
	// Extract
	version, err := git.TagMatch("aws/v*")
	if err != nil {
		return err
	}

	// Build artifact
	return golang.Build("harp-aws", "github.com/elastic/harp-plugins/aws/cmd/harp-aws", version)()
}
	...
	mg.CtxDeps(ctx,
		func() error {
			return golang.Release(
				"harp-aws",
				"github.com/elastic/harp-plugins/aws/cmd/harp-aws",
				version,
